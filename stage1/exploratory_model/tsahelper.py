...
COLORMAP = 'gray'
ID = '0050492f92e22eed3474ae3a6fc907fa'
APS_FILE_NAME = ID + '.aps'
...
def get_subject_labels(df, subject_id):
    return df.loc[df['Subject'] == subject_id]
