...
COLORMAP = 'pink'
APS_FILE_NAME = '00360f79fd6e02781457eda48f85da90.aps'
...
def plot_image_set(infile):
    ...
    img = img.transpose()
    #custom#
    #custom#for ii in range(16):
      #custom#matplotlib.image.imsave('test00'+str(ii)+'.png', img[ii])
    # show the graphs
    fig, axarr = plt.subplots(nrows=4, ncols=4, figsize=(10,10))
...
#custom#matplotlib.image.imsave('test0.png', an_img)
#custom#matplotlib.image.imsave('test1.png', zero_centered_img)
